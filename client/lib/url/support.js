...
export const AUTOMATIC_RENEWAL = `${ root }/manage-purchases/#automatic-renewal`;
...
export const MAP_EXISTING_DOMAIN_UPDATE_DNS = `${ root }/domains/map-existing-domain#change-your-domains-name-servers`;
